...
NC_LUAI_FUNC void luaH_setint (lua_State *L, Table *t, lua_Integer key,
                                                    TValue *value);
...
NC_LUAI_FUNC TValue *luaH_newkey (lua_State *L, Table *t, const TValue *key);
NC_LUAI_FUNC TValue *luaH_set (lua_State *L, Table *t, const TValue *key);
NC_LUAI_FUNC Table *luaH_new (lua_State *L);
NC_LUAI_FUNC void luaH_resize (lua_State *L, Table *t, unsigned int nasize,
                                                    unsigned int nhsize);
NC_LUAI_FUNC void luaH_resizearray (lua_State *L, Table *t, unsigned int nasize);
NC_LUAI_FUNC void luaH_free (lua_State *L, Table *t);
NC_LUAI_FUNC int luaH_next (lua_State *L, Table *t, StkId key);
